...
public abstract class Statement {
     ...
     * <p>
     * Idempotency plays a role in {@link com.datastax.driver.core.policies.SpeculativeExecutionPolicy speculative executions}.
     ...
     * {@link QueryOptions#getDefaultIdempotency()}.
     * <p>
    ...
    boolean isIdempotentWithDefault(QueryOptions queryOptions) {
        ...
        if (myValue != null)
            ...
            return queryOptions.getDefaultIdempotency();
    }
}