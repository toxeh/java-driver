...
class RequestHandler {
    ...
    // Not thread-safe but we piggyback on happens-before relationships introduced by other fields
    // (this is used only for debugging so not critical)
    ...
    private void startNewExecution() {
        ...
        SpeculativeExecution execution = new SpeculativeExecution(++executionCount);
